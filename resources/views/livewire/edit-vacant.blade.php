<form action="" class="md:w-1/2 space-y-5" wire:submit.prevent='editVacant'>
    ...
    <div>
        ...
        <x-text-input id="image" class="block mt-1 w-full" type="file" wire:model="newImage" accept="image/jpg, image/png, image/gif" />

        <div class="my-5 w-80">
            <x-input-label :value="__('Imagen Actual')"/>

            <img src="{{ asset('storage/vacants/' . $image) }}" alt="{{ 'Imagen Vacante ' . $title }}">
        </div>
